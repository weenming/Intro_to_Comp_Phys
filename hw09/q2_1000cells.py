...
def MC_Heisenberg(T, N_size=3, N_step=1000, avg=lambda x: avg(x, 100)):
    ...
    np.savetxt(f'./res_10/H_10_at_T={T}', this_H)
...
if __name__ == '__main__':
    cell_number = 10
    steps = 40000
    Ts_10, res_10 = s_to_T(cell_number, steps, Ts=np.linspace(0.001, 10, 200))
    fig, ax = plot(Ts_10, res_10)
    np.savetxt('res_10/all_T', Ts_10)
    np.savetxt('res_10/all_s', res_10['equ_s'])
    ax.set_title(
